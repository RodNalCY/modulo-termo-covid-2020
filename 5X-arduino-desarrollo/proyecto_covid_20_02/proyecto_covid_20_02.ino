...
const String url =  "/aire-lima-2.5/arduinoneodatokairos/insertedToKairOS";
const char* host = "192.168.1.72"; //localhost or www.tecnologiaperu.com
const uint16_t port = 80;  // HTTP PORT
//////////////////////DEFINIMOS//EL//CODIGO//DEL//SENSOR//RESPECTIVAMENTE//////////////////////
String codigoPM = "PUNTAPM";
String codigoDT = "PUNTATEMP";
String codigoDH = "PUNTAHUM";
...
String token = "TeamKairos.ky.e7b0a6f206a28f9fdcbf4c7696753762";
String dui = "75870480";
float medidaPM = 0;
...
void getSaveHost() {
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////
  if (currentMillis - previousMillis >= 1000) { //Definimos el tiempo de envio
    ...
    enviardatos("dui=" + dui +
                ...
                "&medidaw=" + AQI_PM25 +
                "&codigox=" + codigoDT +
                "&medidax=" + global_medidaTEM +
                "&codigoy=" + codigoDH +
                "&mediday=" + global_medidaHUM +
                "&fecha" +
